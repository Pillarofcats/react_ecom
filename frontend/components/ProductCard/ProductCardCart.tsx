...
export default function ProductCardCart({ product }: { product: tCartItem }) {
  ...
  return (
    <div className="flex flex-col border shadow-md rounded-sm overflow-hidden">
      <div className="sm:flex gap-3">
        <div className="flex flex-col m-5">
          <ProductImage
            src={`/products/${product.item.p_id}.jpg`}
        ...
        <div className="flex flex-col justify-center w-full">
          <div className="cartProductsContainer">
            ...
            <div className="grid grid-cols-2 gap-2 ml-[18%]">
              <div>
                <label>Price</label>
                <p>{`$ ${(product.item.price_cent * 0.01).toFixed(2)}`}</p>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2 ml-[18%]">
              <select
                className="hover:cursor-pointer hover:bg-sky-400 rounded-l-md w-fit"
              ...
              <button
                onClick={() => dispatch(removeCartItem(product.item.p_id))}
